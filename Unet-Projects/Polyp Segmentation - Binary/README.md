...
<font size= "4" >
🩺 Welcome to our Medical Polyp Image Segmentation with U-Net and TensorFlow Keras 🔬
<br/><br/> 
The tutorial is divided into four parts:


Part 1: Data Preprocessing and Preparation
In this part, you load and preprocess the polyp dataset, including resizing images and masks, converting masks to binary format, and splitting the data into training, validation, and testing sets.
