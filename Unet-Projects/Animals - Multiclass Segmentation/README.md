...
You can find the link for the [tutorial](https://eranfeit.net/creating-an-animal-segmentation-model-with-u-net-and-tensorflow-keras/) here.  
You can find the link for the [Video tutorial](https://youtu.be/oHc4yrV64wU) here.
